        ...
        <div class="articles col-10">
            ...
            <div class="row add-article">
                <form action="edit.php" method="post">
                    ...
                    <div class="col mb-4">
                        <label for="article" class="form-label">Author</label>
                        <input value="<?=$username;?>" name="username" type="text" class="form-control" readonly aria-label="Article title">
                    </div>
                    <div class="col mb-4">
                        <label for="editor" class="form-label">Comment</label>
                        <textarea name="content" id="editor" class="form-control" placeholder="e.g. My name is John and this is my new article!..."
                                  rows="6"><?=$text1;?></textarea>
                    </div>
                    <div class="col col-6">
